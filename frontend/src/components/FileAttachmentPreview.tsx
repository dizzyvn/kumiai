...
export interface AttachedFile {
  id: string; // temp file ID from backend
  ...
  return (
    <div className="relative group">
      ...
      <div className="relative">
        ...
        <div className="w-20 h-20 rounded-lg border-2 bg-white p-2 flex items-center justify-center relative overflow-hidden">
          {thumbnail ? (
            <img
              src={thumbnail}
      ...
      {/* File info */}
      <div className="mt-1.5 text-xs text-center max-w-[88px]">
