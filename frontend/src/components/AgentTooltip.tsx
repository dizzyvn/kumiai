...
import type { CharacterMetadata } from '@/lib/api';
...
export function AgentTooltip({ character, targetRef }: AgentTooltipProps) {
  ...
  return createPortal(
    ...
    >
      <div className="bg-gray-900 text-white text-xs rounded-lg p-3 shadow-xl pointer-events-auto">
        ...
        <div className="text-gray-300 mb-2">{character.description}</div>
