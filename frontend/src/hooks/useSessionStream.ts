...
export function useSessionStream({
  ...
  const connect = useCallback(() => {
    ...
    const eventSource = new EventSource(`/api/sessions/${instanceId}/stream`);
  ...
  }, [instanceId, processReorderedEvents, flushReorderBuffer]); // Only reconnect when instanceId changes
